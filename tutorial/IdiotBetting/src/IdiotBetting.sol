...
contract IdiotBettingGame {
    ...
    */
    ...
    uint256 lastWinnerTime;
    uint256 constant holdTime = 60*60;
    ...
    function claimPrize() public {
        // your code here
        require(block.timestamp > lastWinnerTime + holdTime && msg.sender == winner,"only winner should claim and need to wait for 1 hour");
