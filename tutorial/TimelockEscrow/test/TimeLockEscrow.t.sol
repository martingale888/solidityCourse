...
contract TimelockEscrowTest is Test {
    ...
    function testTimelock() public {
        ...
        assertEq(timelockEscrowBalanceBefore, 1 ether, "expected 1 ether for before");
        ...
        emit escrowAfter(timelockEscrowBalanceAfter);
    ...
    event escrowAfter(uint256 timelockEscrowBalanceAfter);
